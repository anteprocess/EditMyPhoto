package editmyphoto.anteprocess.com.editmyphoto.filters;
...
import editmyphoto.anteprocess.com.editmyphoto.EditImageActivity;
import editmyphoto.anteprocess.com.editmyphoto.R;
import editmyphoto.anteprocess.com.editmyphoto.photoutils.ImageFilterView;
import editmyphoto.anteprocess.com.editmyphoto.photoutils.PhotoFilter;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    public FilterViewAdapter(EditImageActivity activity, FilterListener filterListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mImageFilterView.setImageResource(R.drawable.placeholder);//setImageBitmap(fromAsset);
